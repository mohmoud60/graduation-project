...
<html lang="en" direction="rtl" dir="rtl" style="direction: rtl">
    ...
    <?php include 'sidebar.php'; ?>
										...
										<div class="flex-lg-row-fluid ms-lg-15">
											...
											<div class="tab-content" id="myTabContent">
													...
													<div class="card pt-4 mb-6 mb-xl-8 ">
                                                        ...
                                                        <!--begin::Summary-->
													<div class="d-flex flex-center flex-column mb-5 " id="sum_total">
													<h2 class="fw-bold"></h2>
													</div>
													<!--end::Summary-->
															<!--end::Card title-->
															...
															<table class="table align-middle table-row-dashed gy-5" id="kt_table_company_report">
																<thead class="border-bottom border-gray-200 fs-7 fw-bold">
																	<tr class="text-start text-muted text-uppercase gs-0">
                                                                        <th class="min-w-30px">إيصال رقم</th>
                                                                        <th class="min-w-50px">من حساب</th>
																		<th class="min-w-40px">المبلغ</th>
																		<th class="min-w-30px">الفئة</th>
                                                                        <th class="min-w-50px">إلى حساب</th>
																		<th class="min-w-40px">المبلغ</th>
																		<th class="min-w-30px">الفئة</th>
                                                                        <th class="min-w-50px">حساب إيراد</th>
                                                                        <th class="min-w-40px">المبلغ</th>
                                                                        <th class="min-w-200px">البيان</th>
                                                                        <th class="min-w-100px">التوقيت</th>
																	</tr>
																</thead>
		...
		<script src="assets/js/js/report/transfer_listing.js"></script>
        <script src="assets/js/js/report/transfer_print.js"></script>
		<!--end::Javascript-->
	</body>
	<!--end::Body-->
</html>