        ...
        e.querySelectorAll('[data-kt-customer-table-filter="delete_row"]').forEach((e => {
            e.addEventListener("click", (function (e) {
                ...
                Swal.fire({
                    ...
                    if(e.value) {
                        $.ajax({
                            url: 'assets/php/process_trader.php',
                            type: 'POST',
                            data: {
                                trader_id: n
                            },
            ...
            Swal.fire({
                ...
                if(n.value) {
                    ...
                    $.ajax({
                        ...
                        type: 'POST',
                        data: {
                            trader_ids: JSON.stringify(selectedTraderIds)
                        },
                        success: function(response) {
                            // Refresh the table
                            t.draw();
                                    ...
                                    <td class="text-end">
                                        <div class="dropdown text-end">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton1">
                                                <li><a class="dropdown-item" href="../../demo1/dist/apps/customers/view.html">عرض</a></li>
