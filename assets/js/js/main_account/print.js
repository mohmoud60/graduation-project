function printData() {
    ...
    var tradersHTML = '';
    var tableHeaders = Array.from(document.querySelectorAll("#mainTable tr"))
    .map((element, index) => {
        var cells = Array.from(element.querySelectorAll('th'));
    ...
    var paymentsPerPageOtherPages = 18;
