...
var KTSuppliersList = function () {
    ...
    var o = () => {
        e.querySelectorAll('[data-kt-main-table-filter="delete_row"]').forEach((e => {
            e.addEventListener("click", (function (e) {
                ...
                Swal.fire({
                    ...
                    if(e.value) {
                        $.ajax({
                            url: 'assets/php/process_main_account.php',
                            type: 'POST',
                            data: {
                                account_id: n
                            },
    ...
    var n = () => {
        const o = e.querySelectorAll('[type="checkbox"]'),
            n = document.querySelector('[data-kt-main-table-select="delete_selected"]');
    ...
    const c = () => {
        const t = document.querySelector('[data-kt-main-table-toolbar="base"]'),
            o = document.querySelector('[data-kt-main-table-toolbar="selected"]'),
            n = document.querySelector('[data-kt-main-table-select="selected_count"]'),
    ...
    return {
        init: function () {
            (e = document.querySelector("#mainTable")) && (
                (t = $(e).DataTable({
                    processing: true,
                    serverSide: true,
                    destroy: true,
                    ...
                    "columns": [
                        ...
                        },
                        {
                            ...
                            "render": function (data, type, row) {
                                return '<a href="main_account_view.php?account_id=' + row.account_number + '" class="text-dark text-hover-primary mb-1 fs-3">' + row.currency_id + ' ' + row.account_type + ' ' + data +'</a>';
                            }
                        },
                        { 
                            "data": "account_Sname",
                            "render": function (data, type, row) {
                                return '<a href="main_account_view.php?account_id=' + row.account_number + '"class="text-dark text-hover-primary mb-1 fs-3">' + data + '</a>';
                            }
                        },
                        { 
                            "data": "type_sname",
                        ...
                        { 
                            "data": "account_amount",
                            "render": function (data, type, row) {
                                return '<a class="text-dark text-hover-primary mb-1 fs-3">' + data + ' ' + row.currency_symbole + ' </a>';
                            }
                        },
                        { 
                            "data": "currency_sname",
                                    ...
                                    <td class="text-end">
                                        <div class="dropdown text-end">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton1">
                                                <li><a class="dropdown-item" href="main_account_view.php?account_id=${data}">عرض</a></li>
                                                <li><a class="dropdown-item" href="#" data-kt-main-table-filter="delete_row">حذف</a></li>
                                            </ul>
                                        </div>
                                    </td>`;
                            }
