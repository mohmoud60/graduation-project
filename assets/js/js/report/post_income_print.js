function printData() {
    ...
    var paymentsPerPageFirstPage = 12;  // How many payments you want per the first page
    var paymentsPerPageOtherPages = 15;  // How many payments you want per other pages
            ...
            <div class="header py-3">
                ...
                <main class="container">
                    <div class="text-center">
                        <h1>تقرير سجل ترحيل الإيرادات</h1>
                    </div>
