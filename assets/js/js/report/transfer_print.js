function printData() {
    ...
    var balances = Array.from(document.querySelectorAll("#sum_total"))
    ...
    var paymentsPerPageFirstPage = 10;  // How many payments you want per the first page
    var paymentsPerPageOtherPages = 12;  // How many payments you want per other pages
