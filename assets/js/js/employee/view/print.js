function printData() {
    ...
    var employee_id = document.getElementById("employee_id").innerText;
    var Salary1 = document.getElementById("Salary1").innerText;
    var fromDate = document.getElementById("from_date").value;
    var toDate = document.getElementById("to_date").value;
    var payments = Array.from(document.querySelectorAll("#kt_table_employee_payment tr"))
        .map(element => element.outerHTML);
    
    var paymentsHTML = '';
    // Fetch table headers
    var tableHeaders = document.querySelector("#kt_table_employee_payment tr").outerHTML;

    var paymentsPerPageFirstPage = 16; 
            ...
            <div class="header py-3">
                ...
                <main class="container">
                    <div class="text-center">
                        <h1>بيان مالي للموظف</h1>
                    </div>
                    <div class="row justify-content-between">
                        <div class="col-auto">
                            <h2 class="text-dark">${employee_id}</h2>
                        </div>
                        <div class="col-auto">
