        ...
        e.querySelectorAll('[data-kt-main-table-filter="delete_row"]').forEach((e => {
            e.addEventListener("click", (function (e) {
                ...
                Swal.fire({
                    ...
                    if(e.value) {
                        $.ajax({
                            url: 'assets/php/process_currency_setting.php?action=delete_currency',
                            type: 'POST',
                            data: {
                                account_id: n
                            },
        ...
        n.addEventListener("click", (function () {
            Swal.fire({
                ...
                if(n.value) {
                    ...
                    $.ajax({
                        url: 'assets/php/process_currency_setting.php?action=delete_currencys',
                        type: 'POST',
                        data: {
        ...
        init: function () {
            (e = document.querySelector("#mainTable")) && (
                (t = $(e).DataTable({
                    ...
                    retrieve: true,
                    ajax: {
                        url: 'assets/php/process_currency_setting.php?action=show_currency',
                        type: 'GET'
                    },
                    language: {
