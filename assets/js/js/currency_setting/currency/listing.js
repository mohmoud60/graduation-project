...
var KTSuppliersList = function () {
    ...
    var o = () => {
        e.querySelectorAll('[data-kt-main-table-filter="delete_row"]').forEach((e => {
            e.addEventListener("click", (function (e) {
                ...
                const n_name = o.querySelectorAll("td")[2].innerText;
                ...
                Swal.fire({
                    ...
                    if(e.value) {
                        $.ajax({
                            url: 'assets/php/process_currency_setting.php?action=delete_currency_settings',
                            type: 'POST',
                            data: {
                                account_id: n
                            },
    ...
    var n = () => {
        ...
        n.addEventListener("click", (function () {
            Swal.fire({
                text: "هل أنت متأكد أنك تريد حذف الفئات المختارة ؟",
                icon: "warning",
                showCancelButton: !0,
                buttonsStyling: !1,
                confirmButtonText: "نعم ، احذف!",
                ...
                if(n.value) {
                    ...
                    $.ajax({
                        url: 'assets/php/process_currency_setting.php?action=delete_currencys_settings',
                        type: 'POST',
                        data: {
                        ...
                        success: function(response) {
                            ...
                            Swal.fire({
                                text: "لقد قمت بحذف جميع  الفئات المختارة  !.",
                                icon: "success",
                                buttonsStyling: !1,
                                confirmButtonText: "حسنًا!",
                                customClass: {
                        ...
                        error: function() {
                            Swal.fire({
                                text: "لم يتم حذف  الفئات المختارة .",
                                icon: "error",
                                buttonsStyling: !1,
                                confirmButtonText: "حسنًا!",
                                customClass: {
        ...
        init: function () {
            (e = document.querySelector("#mainTable")) && (
                (t = $(e).DataTable({
                    ...
                    retrieve: true,
                    ajax: {
                        url: 'assets/php/process_currency_setting.php?action=show_currency_settings',
                        type: 'GET'
                    },
                    language: {
                        ...
                        },
                        {
                            ...
                            "render": function (data) {
                                ...
                                return `
                                    ...
                                    `; // عدم عرض أي شيء إذا لم يكن المستخدم هو Admin
                                }
                            }
                        }
                    ],
