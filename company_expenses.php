...
<html lang="en" direction="rtl" dir="rtl" style="direction: rtl">
    ...
    <?php include 'sidebar.php'; ?>
										...
										<div class="flex-column flex-lg-row-auto w-100 w-xl-350px mb-10">
											...
											<div class="card mb-5 mb-xl-8">
												...
												<div class="card-body pt-15" id="total">
													...
													<h2 class="fw-bold">إجمالي المصروفات</h2>
													</div>
													<!--end::Summary-->
												</div>
												<!--end::Card body-->
															...
															<table class="table align-middle table-row-dashed gy-5" id="kt_table_company_report">
																<thead class="border-bottom border-gray-200 fs-7 fw-bold">
																	<tr class="text-start text-muted text-uppercase gs-0">
                                                                        <th class="min-w-100px">رقم السند</th>
                                                                        <th class="min-w-100px">نوع السند</th>
																		<th class="min-w-100px">الأسم</th>
																		<th class="min-w-100px">المبلغ</th>
																		<th class="min-w-100px">البيان</th>
																		<th class="min-w-100px">التاريخ</th>																	</tr>
																</thead>
		...
		<script src="assets/js/js/report/expenses_listing.js"></script>
        <script src="assets/js/js/report/expenses_print.js"></script>
		<!--end::Javascript-->
	</body>
	<!--end::Body-->
</html>